...
<h2 class="text-center">Register </h2>
 <?php
		...
		$dbemail=$rows['email'];
		if($name==null || $lastname==null || $email==null || $password==null || $password1==null) echo "<h3 class='text-center'>Please Fill The Form</h3>";
		else{
		if($dbemail==$email){echo"<h3 class='text-center'>This email $email is already registerd</h3>";}
		else {
  ...
  }else echo "<h3 class='text-center'> Both Passwords are not matched</h3>";
		}
